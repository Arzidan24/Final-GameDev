...
// This script is responsible for the camera following the player, placed in the main camera game object, It also serves as to be able to restart the game when the player is unable to countinue (game over)
